 ...
 */
@property(nonatomic, readonly) OMIDBuzztechnoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDBuzztechnoAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDBuzztechnoAdSessionContext *)context
